      ...
      <select
        ...
        >
          <option value="Service">
             <Link to={"/labour-report"}>Service</Link>
          </option>
          <option value="WorkOrder"><Link to={"/labour-report-workorder"}>Work Order</Link></option>
          <option value="SkippedStop"><Link to={"/labour-report-skipped"}>Skipped Stop</Link></option>
        </select>
