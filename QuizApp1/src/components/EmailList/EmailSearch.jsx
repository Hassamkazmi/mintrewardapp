...
export default function AddCustomerForm({ emailData }) {
  ...
  const handleChangeTags = (value) => {
    ...
    dispatch(postEmailboardcastData({ Tags }));
    settags(value);
  };
    ...
    <Fragment>
      <div className="row fomik customer">
        <Form
          ...
          autoComplete="off"
        >
          <div className="row customerInfo emailFilters">
            <Radio.Group onChange={(e) => onChangeRadio(e)}>
              <div className="row ">
                ...
                <div className="col-sm-12">
                  <Radio value="withDateSelects">
                    <p>Customers with These Tags</p>
                  </Radio>
                </div>
                <div className="col-sm-12">
                  <Form.Item name="Tags">
                ...
                <div className="col-sm-12 ">
                  <Radio value="scheduled">
                    <p>Customers Scheduled to be Serviced</p>
                  </Radio>
                </div>
                ...
                <div className="col-sm-12 ">
                  <Radio value="routeAss">
                    <p>Customers with Route Assignments (current or future)</p>
                  </Radio>
                </div>
                <div className="col-sm-12">
                  <Form.Item name="days">
            ...
            <div className="col-sm-12 savebtn emailList">
              <Form.Item>
                {
                  emailData?.data?.length === 0 ?  <Button
                  onClick={toastAlert}
