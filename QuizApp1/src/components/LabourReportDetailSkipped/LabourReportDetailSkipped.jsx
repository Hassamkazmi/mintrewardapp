              ...
              {skippedStopReport?.items?.map((item , key) => (
                <tr>
                  ...
                  <td>
                    ...
                    <b>{item?.SkipRouteAssignmentRouteAssignmentData?.RouteAssignmentWaterBody?.RouteAssignmentServiceLocation?.CustomerServiceLocation?.first_name}</b>
                  </td>
                  <td>{item?.SkipRouteAssignmentRouteAssignmentData?.RouteAssignmentWaterBody?.name}</td>
                  <td>{item?.SkipRouteAssignmentRouteAssignmentData?.RouteAssignmentFrequency?.name}</td>
                </tr>
              ))}
            </tbody>
          </table>
