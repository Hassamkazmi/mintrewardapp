        ...
        <Form name="dynamic_form_item" onFinish={onFinishs}>
          ...
          <div className="row serviceLogDetailPageCols">
            <div className="col-sm-6 forFullWidth">
              {
                data?.CompletedServiceRoutesReadingActivity?.length !== 0 ?  <ServiceReading data={data?.CompletedServiceRoutesReadingActivity}/> : <></>
              }
             
            </div>
            <div className="col-sm-6 forFullWidth ">
              {
                data?.CompletedServiceRoutesDosageActivity?.length !== 0 ?  <DosagesList data={data?.CompletedServiceRoutesDosageActivity}/> : <></>
              }
          ...
          <div className="row serviceLogDetailPageCols">
            <div className="col-sm-6 forFullWidth">
              {
                data?.CompletedServiceRouteEquipmentServiceData?.length !== 0 ?  <ServiceEquipment data={data?.CompletedServiceRouteEquipmentServiceData}/> : <></>
              }
             
            </div>
            <div className="col-sm-6 forFullWidth ">
              {
                data?.CompletedServiceRouteItemNeededServiceData?.length !== 0 ?  <ServiceItemNeeded data={data?.CompletedServiceRouteItemNeededServiceData}/> : <></>
              }
